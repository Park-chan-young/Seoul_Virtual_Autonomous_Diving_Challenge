...
class PEDESDetector:
    def __init__(self):
        ...
        self.image_pub = rospy.Publisher("/pedes_positions", Int32MultiArray, queue_size=1)
    ...
    def callback(self, msg):
        ...
        pedes_msg = Int32MultiArray(data=np.ravel(pedes_positions))
        self.image_pub.publish(pedes_msg)
